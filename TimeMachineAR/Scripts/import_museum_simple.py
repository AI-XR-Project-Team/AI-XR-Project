...
task.filename = str(project / "Asset/NavReference/T_MuseumSimple.png")
task.destination_path = "/Game/UI/Nav/Reference"
task.destination_name = "T_MuseumSimple"
task.automated = True
task.replace_existing = True
task.save = False
unreal.AssetToolsHelpers.get_asset_tools().import_asset_tasks([task])
texture = unreal.load_asset("/Game/UI/Nav/Reference/T_MuseumSimple")
