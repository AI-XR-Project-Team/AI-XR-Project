...
task.filename = str(project / "Asset/NavReference/T_MuseumReference.png")
task.destination_path = "/Game/UI/Nav/Reference"
task.destination_name = "T_MuseumReference"
task.automated = True
task.replace_existing = True
task.save = False
unreal.AssetToolsHelpers.get_asset_tools().import_asset_tasks([task])
texture = unreal.load_asset("/Game/UI/Nav/Reference/T_MuseumReference")
